...
[JsonConverter(typeof(EvDbDomainNameSystemTextJsonConverter))]
[TypeConverter(typeof(EvDbDomainNameTypeConverter))]
[DebuggerTypeProxy(typeof(EvDbDomainNameDebugView))]
[DebuggerDisplay("Underlying type: string, Value = { _value }")]
public partial struct EvDbDomainName :
    IEquatable<EvDbDomainName>,
    IEquatable<string>,
    IComparable<EvDbDomainName>,
    IComparable,
    IParsable<EvDbDomainName>
{
    #region Validation
    ...
    private static Validation Validate(string value) => Validator().IsMatch(value) switch
    {
        ...
        true => Validation.Ok,
        _ => Validation.Invalid("The domain name must start with letters (A-Z) or (a-z), follow by alphabets, numbers, or the characters `-`, `_`, `.`, `@`, or `#`  .")
    };
    ...
    [DebuggerStepThroughAttribute]
    private EvDbDomainName(string value)
    {
        _value = value;
        _isInitialized = true;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EvDbDomainName From(string value)
    {
        value = Format(value);
        var validation = EvDbDomainName.Validate(value);
        if (validation != Validation.Ok)
        {
            ThrowHelper.ThrowWhenValidationFails(validation);
        }

        return new EvDbDomainName(value);
    }
    ...
    public static ValueObjectOrError<EvDbDomainName> TryFrom(string value)
    {
        if (value is null)
        {
            return new ValueObjectOrError<EvDbDomainName>(Validation.Invalid("The value provided was null"));
        }
        ...
        if (validation != Validation.Ok)
        {
            return new ValueObjectOrError<EvDbDomainName>(validation);
        }

        return new ValueObjectOrError<EvDbDomainName>(new EvDbDomainName(value));
    }
...
#pragma warning disable S4144 // Methods should not have identical implementations
    private static EvDbDomainName __Deserialize(string value)
    {
        value = Format(value);
        var validation = EvDbDomainName.Validate(value);
        if (validation != Validation.Ok)
...
#pragma warning restore S4144 // Methods should not have identical implementations
    ...
    public readonly bool Equals(EvDbDomainName other)
    {
    ...
    public bool Equals(EvDbDomainName other, IEqualityComparer<EvDbDomainName> comparer)
    {
    ...
    {
        return obj is EvDbDomainName && Equals((EvDbDomainName)obj);
    }

    public int CompareTo(EvDbDomainName other) => Value.CompareTo(other.Value);
    public int CompareTo(object? obj)
    {
        if (obj is null)
            return 1;
        if (obj is EvDbDomainName x)
            return CompareTo(x);
        ThrowHelper.ThrowArgumentException("Cannot compare to object as it is not of type EvDbDomainName", nameof(obj));
        return 0;
    }
    ...
    public static implicit operator string(EvDbDomainName vo) => vo._value!;
    public static implicit operator EvDbDomainName(string value)
    {
        return EvDbDomainName.From(value);
    }

    public static bool operator ==(EvDbDomainName left, EvDbDomainName right) => left.Equals(right);
    public static bool operator !=(EvDbDomainName left, EvDbDomainName right) => !(left == right);
    public static bool operator ==(EvDbDomainName left, string? right) => left.Value.Equals(right);
    public static bool operator ==(string? left, EvDbDomainName right) => right.Value.Equals(left);
    public static bool operator !=(string? left, EvDbDomainName right) => !(left == right);
    public static bool operator !=(EvDbDomainName left, string? right) => !(left == right);

    public static bool operator <(EvDbDomainName left, EvDbDomainName right)
    {
        ...
        out EvDbDomainName result)
    {
        ...
        var validation = EvDbDomainName.Validate(s);
        if (validation != Validation.Ok)
        {
            result = default;
            return false;
    ...
    /// </returns>
    public static EvDbDomainName Parse(string s, IFormatProvider? provider)
    {
        return From(s!);
    }
    ...
    #region EvDbDomainNameSystemTextJsonConverter

#nullable disable
    /// <summary>
    /// Converts a EvDbDomainName to or from JSON.
    /// </summary>
    public class EvDbDomainNameSystemTextJsonConverter : JsonConverter<EvDbDomainName>
    {
        public override EvDbDomainName Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            return EvDbDomainName.__Deserialize(reader.GetString());
        }

        public override void Write(Utf8JsonWriter writer, EvDbDomainName value, JsonSerializerOptions options)
        {
            writer.WriteStringValue(value.Value);
        }

        public override EvDbDomainName ReadAsPropertyName(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            return EvDbDomainName.__Deserialize(reader.GetString());
        }

        public override void WriteAsPropertyName(Utf8JsonWriter writer, EvDbDomainName value, JsonSerializerOptions options)
        {
...
#nullable restore
    ...
    #endregion //  EvDbDomainNameSystemTextJsonConverter

#nullable disable
    #region EvDbDomainNameTypeConverter

    class EvDbDomainNameTypeConverter : TypeConverter
    {
        ...
        public override Object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, Object value)
        {
            ...
            {
                return EvDbDomainName.__Deserialize(stringValue);
            }
        ...
        {
            if (value is EvDbDomainName idValue && destinationType == typeof(string))
            {
    ...
    #endregion //  EvDbDomainNameTypeConverter
#nullable restore
...
#pragma warning restore S3925 // "ISerializable" should be implemented correctly
    ...
    #region EvDbDomainNameDebugView
...
#pragma warning disable S1144 // Unused private types or members should be removed
    internal sealed class EvDbDomainNameDebugView
    {
        private readonly EvDbDomainName _t;
        EvDbDomainNameDebugView(EvDbDomainName t)
        {
            _t = t;
        }
...
#pragma warning restore S2325 // Methods and properties that don't access instance data should be static
    ...
    #endregion //  EvDbDomainNameDebugView
